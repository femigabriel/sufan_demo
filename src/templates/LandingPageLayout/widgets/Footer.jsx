...
const Footer = () => {
  return (
    <footer
      ...
      className="px-4 sm:px-6 md:px-10 py-10 md2:pt-[102px] bg-cover bg-[#2238B4] bg-no-repeat lg:hscreen lg:maxh-[429px]"
    >
      <div className="max-w-[1170px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between">
          <div>
            <Link to={"/"} className="flex gap-5 itemscenter">
              <span>
                <img src="/logo_v2.png" alt="logo" className="mainLogo" />
              </span>
              <p className="font-bold self-end text-white font-Inter text-xl md:text-3xl md2:text-4xl">
                Bles Client Platform
              </p>
            </Link>

            <p className="mt-6 md2:mt-12 max-w-[470px] font-normal text-[#99A9FF] text-sm">
              At Bles Software, we harness the power of innovation to craft
              intelligent solutions that redefine the digital landscape.{" "}
              <br></br> Empower Tomorrow, Today with Bles!,
            </p>
          </div>

          <div className="socials mt-7 flex gap-6 items-center self-end">
            <a
        ...
        <div className="border-t flex py-5 justify-between items-center text-light-blue text-sm md:text-base border-light-blue mt-10 md2:mt-20">
