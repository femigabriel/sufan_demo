...
function MyDataTable2({
    ...
    return (
        <div
            id={"table"}
            className={`my-table2 ${hideScollbar ? "hideScrollbar" : "scrollbar-style"}  ${scrollX ? "scrollX" : ""} ${alignLastTdRight ? "alignLastTdRight" : ""
                } `}
        >
            <MUIDataTable
                title={title}
